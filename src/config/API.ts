const API = {
  ...
  GERMAN_STANDARD_PRODUCTS:
    "http://103.120.178.195/Sang.GermanStandard.API/tag/getproducts", //GET products by category and subcategory

  // Legacy endpoint aliases for backward compatibility
  CATEGORY_WITH_SUBCATEGORIES:
    "http://103.120.178.195/Sang.GermanStandard.API/tag/getsubcategorybycategory",
  PRODUCTS_BY_CATEGORY:
    "http://103.120.178.195/Sang.GermanStandard.API/tag/getproducts",
